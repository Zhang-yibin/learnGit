...
//    if (send_data.yaw_angle > 0) {
//        transmit_data[1] = 1;}
//    else
//    {       transmit_data[1] = 0;}
////    cout<<transmit_data[1]<<endl;
////    transmit_data[3] = (unsigned
////    char) ((int)send_data.yaw_angle/100);    // integer part
//    transmit_data[2] = (unsigned char) ((int)(send_data.yaw_angle)%100);  // fractional part
////    cout<<111<<send_data.yaw_angle<<endl<<endl;
//
//    transmit_data[3] = (unsigned char) ((int)(send_data.yaw_angle*100)%100);
////    cout<<transmit_data[2]<<transmit_data[3]<<endl;
////    cout<<send_data.yaw_angle<<endl;
//    if(send_data.pitch_angle>0) {
//        transmit_data[4] = 1;}
//    else {
//        transmit_data[4] = 0;}
//
//    transmit_data[5] = (unsigned char) ((int)send_data.pitch_angle % 256);
//    transmit_data[6] = (unsigned char) (((int) (send_data.pitch_angle * 100) % 100));
////    transmit_data[7] = (unsigned char) (int(send_data.distance/100));   // High eight
////    transmit_data[8] = (unsigned char) (send_data.detect_flag);    // detection marker ???
//
///*    transmit_data[0] = frame_head;
...
//    cout<<111<<send_data.yaw_angle<<endl<<endl;
    ...
    if(send_data.yaw_angle<0)
    {       transmit_data[1] = 0;
        send_data.yaw_angle= abs(send_data.yaw_angle);
        transmit_data[2] = (unsigned char) ((int)(send_data.yaw_angle)%100);  // fractional part
//    cout<<111<<send_data.yaw_angle<<endl<<endl;
...
//    cout<<send_data.yaw_angle<<endl;
    if(send_data.pitch_angle>0) {
        ...
        transmit_data[4] = 0;
        send_data.pitch_angle=abs(send_data.pitch_angle);
        transmit_data[5] = (unsigned char) ((int)send_data.pitch_angle % 256);
        transmit_data[6] = (unsigned char) (((int) (send_data.pitch_angle * 100) % 100));}
