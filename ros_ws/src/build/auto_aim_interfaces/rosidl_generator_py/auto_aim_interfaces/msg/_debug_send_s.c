...
bool auto_aim_interfaces__msg__debug_send__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("auto_aim_interfaces.msg._debug_send.DebugSend", full_classname_dest, 45) == 0);
  }
  auto_aim_interfaces__msg__DebugSend * ros_message = _ros_message;
  {  // point
...
{
  /* NOTE(esteve): Call constructor of DebugSend */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("auto_aim_interfaces.msg._debug_send");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DebugSend");
