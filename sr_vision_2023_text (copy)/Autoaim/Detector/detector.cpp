...
string model_path = "/home/yukki/Downloads/sr_vision_2023_06/Autoaim/Classifier/model/mlp1.onnx";
string label_path = "/home/yukki/Downloads/sr_vision_2023_06/Autoaim/Classifier/model/qwq.txt";
...
//            cout<<"ligt1"<<light_1->color<<endl;
...
#endif
            //if the armor is valid,create object 'Armor' and put it into vector 'armors'
    ...
    //adjust the position of the armor vertices to match the lights.
    if(!armors.empty()){
...
//Ratio,center distance and the angle of light center connection,three criteria to estimate if the armor is valid.
