...
struct RuneParam
{
    ...
    double max_contourArea = 49000;
    double min_contourArea = 1000;

    //Select the fan
    double max_fan_area = 49000;
    double min_fan_area = 1000;
    double min_area_ratio = 1.1;
    double min_fan_ratio = 1.1;
    double max_fan_ratio = 2.9;
    //this ratio is wide/long
    // but what i should to add is the area/area
